...
\item
  ...
  Moderate experience in modeling novel statistical concepts for
  longitudinal measurements for barley and alfalfa
\item
  ...
  control, command line, and image stitching applications. Basic
...
\item
  ...
  3 alfalfa locations, from stitching to image value extraction
\item
  Used random regression statistical software to model alfalfa growth
  curves using extracted NDVI values as a proxy
\item
  Experience using open source database breeding software such as
  Imagebreed and Breedbase
\end{itemize}
...
\item
  ...
  Naked Barley for Organic Systems''
\item
