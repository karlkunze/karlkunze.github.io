...
$if(orcidlink)$\usepackage{orcidlink}$endif$
...
$if(email)$$if(orcidlink)$\orcidlink{0000-0003-4548-1808}\hspace{1 mm}$else$\emph{Orcid:}$endif${\tt $orcid$} \hspace{1 mm}$endif$
}
